...
use Pterodactyl\Http\Requests\Api\Application\Nodes\StoreNodeAutoDeployTokenRequest;

class NodeAutoDeployController extends ApplicationApiController
{
    /**
     ...
     */
    public function __invoke(StoreNodeAutoDeployTokenRequest $request, Node $node): JsonResponse
    {
        $key = ApiKey::query()
